...
describe('getViewerNarouUrl', () => {
	test.each([
		{ ncode: 'n1234', page: 1, expected: '/view/n1234/1' },
		{ ncode: 'n1234', page: 0, expected: '/view/n1234/0' },
...
describe('getProxyNarouUrl', () => {
	test.each([
		{ ncode: 'n1234', page: 1, expected: '/proxy/n1234/1' },
		{ ncode: 'n1234', page: 0, expected: '/proxy/n1234/0' },
...
describe('getPageInfo', () => {
	...
	])('getPageInfo($currentPage, $totalPage) -> $expected', ({ currentPage, totalPage, expected }) => {
